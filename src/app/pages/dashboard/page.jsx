...
const Dashboard = () => {
 ...
 const tableData = [
  ['00001', '2022-01-01', 'Loto', 'Gagné', 3, '1,2,3,4,5,6', '1,24,2,12,8,3', 3],
  ...
  return (
    <div className={styles.pageDashboard}>
      ...
      <button className={styles.btnDeconnectDashboard} onClick={handleLogout}>Déconnexion</button>
</div>
  ...
  {tableData.map((rowData, rowIndex) => (
    <tr key={rowIndex} className={rowIndex % 2 === 0 ? styles["even-row"] : styles["odd-row"]}>
