...
const SearchPage = () => {
  ...
  return (
      ...
      <div className={styles.pagesearchbar}  style={{
          ...
          <ol type='I' className={styles.olsearch}>
            {searchResults.map((result, index) => (
              <li className={styles.lisearch} key={index}>
                <Link href={result.path === "/" ? "/" : `/pages/${result.path}`} className={styles.linksearch}>
        ...
        <Image priority={true} as="image" src="/images/robots/robot8.webp" alt="robot8" className={styles.robot8} width={670} height={600} />
      </div>
      </div>
