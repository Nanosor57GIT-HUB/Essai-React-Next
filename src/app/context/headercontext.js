...
useEffect(() => {
  ...
  //fin de gestion d'ouverture et fermeture du burger menu et de la barre de navigation principale**************************************************
    ...
    return (
      <HeaderContext.Provider value={{ isMenuOpen, setIsMenuOpen, toggleMenu, toggleBurger, burgerActive, isNavOpen, setBurgerActive, closeMenuBurger,closeDropdownMenu, dropdownMenuRef, menuContainerRef }}>
        {children}
